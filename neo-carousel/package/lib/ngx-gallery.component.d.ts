...
export declare class NgxGalleryComponent implements OnInit, DoCheck, AfterViewInit {
    ...
    widthOption: string;
    heightOption: string;
    thumbnailsColumnsOption: number;
    startIndexOption: number;
    imageDescriptionOption: boolean;
    imageArrowsOption: boolean;
    thumbnailsArrowsOption: boolean;
    previewArrowsOption: boolean;
    imageSwipeOption: boolean;
    thumbnailsSwipeOption: boolean;
    previewSwipeOption: boolean;
    imageAutoPlayOption: boolean;
    imageAutoPlayIntervalOption: number;
    imageAutoPlayPauseOnHoverOption: boolean;
    imageInfinityMoveOption: boolean;
    previewOption: boolean;
    arrowPrevIconOption: string;
    arrowNextIconOption: string;
    previewPrevIconOption: string;
    previewNextIconOption: string;
    thumbnailsOption: boolean;
